...
KEY="5879448023:AAHudzehxUmKC0n5Uyq2LOcTdR387T37eEY"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Xiera27/jeruk/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install Backup
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Xiera27/jeruk/main/limit/limit.sh;chmod +x limit.sh;./limit.sh
sleep 3
clear
# > pasang gotop
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By XLORD PROJECT ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
